/*
  Desenvolvido por Roberto S. Melo - 02-04-2025
*/
...
contract Ezzepaycoin is IERC20 {
    string public constant name = "EzzePay Coin";
    string public constant symbol = "EZZEPAY";
    ...
    function transferFrom(address owner, address buyer, uint256 numTokens) public override returns (bool) {
        ...
        require(numTokens <= allowances[owner][msg.sender], "Allowance exceeded");
